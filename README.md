...
## Cpp
 ...
 - Hanoi.cpp : 河內塔步驟模擬, 函數參數包含一個會印出每一步被移動盤子的編號的參數。

## Python
 - py312 : The Practiced Scripts for Learning python 3.12 Version Coding.
 - test : A test folder for something expertimences
 - DsPy: Data Structure in Python
 - Pygame_AirPlane_Demo: A little playing Game with Pygame for demo
